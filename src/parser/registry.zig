...
const primitive_descriptors = [_]PrimitiveDescriptor{
    ...
    .{ .op = .add, .name = "add", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .number, .number }, .result_sort = .number, .summary = "数値を加算する" },
    .{ .op = .sub, .name = "sub", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .number, .number }, .result_sort = .number, .summary = "数値を減算する" },
    .{ .op = .mul, .name = "mul", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .number, .number }, .result_sort = .number, .summary = "数値を乗算する" },
    .{ .op = .div, .name = "div", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .number, .number }, .result_sort = .number, .summary = "数値を除算する" },
    .{ .op = .min, .name = "min", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .number, .number }, .result_sort = .number, .summary = "小さい方の数値を返す" },
    .{ .op = .max, .name = "max", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .number, .number }, .result_sort = .number, .summary = "大きい方の数値を返す" },
    .{ .op = .str, .name = "str", .min_arity = 1, .max_arity = 1, .arg_names = &.{"value"}, .arg_sorts = &.{.number}, .result_sort = .string, .summary = "数値を string に変換する" },
    .{ .op = .concat, .name = "concat", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "left", "right" }, .arg_sorts = &.{ .string, .string }, .result_sort = .string, .summary = "string を連結する" },
    ...
    .{ .op = .text, .name = "text", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "content", "role_name" }, .arg_sorts = &.{ .string, .string }, .result_sort = .object, .effect = .builds_graph, .summary = "互換 sugar: text object を作る" },
    .{ .op = .object, .name = "object", .min_arity = 3, .max_arity = 3, .arg_names = &.{ "content", "role_name", "payload_name" }, .arg_sorts = &.{ .string, .string, .string }, .result_sort = .object, .effect = .builds_graph, .summary = "低水準 object constructor" },
    .{ .op = .group, .name = "group", .min_arity = 1, .max_arity = 255, .arg_names = &.{"child"}, .arg_sorts = &.{.object}, .result_sort = .object, .effect = .builds_graph, .summary = "複数 object の bbox group を作る" },
    ...
    .{ .op = .page_number_object, .name = "page_number_object", .min_arity = 0, .max_arity = 0, .arg_names = &.{}, .arg_sorts = &.{}, .result_sort = .object, .effect = .builds_graph, .summary = "互換 sugar: page number object を作る" },
    .{ .op = .toc_object, .name = "toc_object", .min_arity = 0, .max_arity = 0, .arg_names = &.{}, .arg_sorts = &.{}, .result_sort = .object, .effect = .builds_graph, .summary = "互換 sugar: ToC object を作る" },
    .{ .op = .rewrite_text, .name = "rewrite_text", .min_arity = 3, .max_arity = 3, .arg_names = &.{ "base", "old", "new" }, .arg_sorts = &.{ .object, .string, .string }, .result_sort = .object, .effect = .builds_graph, .summary = "互換 sugar: text rewrite transform を適用する" },
    .{ .op = .highlight, .name = "highlight", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "base", "note" }, .arg_sorts = &.{ .any, .string }, .result_sort = .object, .effect = .builds_graph, .summary = "互換 sugar: highlight transform を適用する" },
    .{ .op = .constraints, .name = "constraints", .min_arity = 0, .max_arity = 255, .arg_names = &.{"constraint_set"}, .arg_sorts = &.{.constraints}, .result_sort = .constraints, .effect = .adds_constraints, .summary = "ConstraintSet を束ねる" },
    ...
    .{ .op = .report_error, .name = "report_error", .min_arity = 1, .max_arity = 1, .arg_names = &.{"message"}, .arg_sorts = &.{.string}, .result_sort = .string, .effect = .reports_diagnostics, .summary = "ユーザ定義検査から error diagnostic を報告する" },
    .{ .op = .report_warning, .name = "report_warning", .min_arity = 1, .max_arity = 1, .arg_names = &.{"message"}, .arg_sorts = &.{.string}, .result_sort = .string, .effect = .reports_diagnostics, .summary = "ユーザ定義検査から warning diagnostic を報告する" },
    .{ .op = .require_asset_exists, .name = "require_asset_exists", .min_arity = 1, .max_arity = 1, .arg_names = &.{"object"}, .arg_sorts = &.{.object}, .result_sort = .object, .effect = .reports_diagnostics, .summary = "asset object の参照先ファイルが存在することを検査する" },
};
