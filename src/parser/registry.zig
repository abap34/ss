...
const primitive_descriptors = [_]PrimitiveDescriptor{
    ...
    .{ .op = .set_prop, .name = "set_prop", .min_arity = 3, .max_arity = 3, .arg_names = &.{ "object", "key", "value" }, .arg_sorts = &.{ .object, .string, .string }, .result_sort = .object, .summary = "Attach a property to an object" },
