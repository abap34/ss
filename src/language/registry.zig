...
const primitive_descriptors = [_]PrimitiveDescriptor{
    ...
    .{ .op = .place_on, .name = "place_on!", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "page", "object" }, .arg_types = &.{ Type.page, Type.object }, .result_type = Type.object, .places_objects = true, .summary = "Place an object on a page" },
