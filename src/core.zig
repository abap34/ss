...
pub const ConstMap = @import("core/ir.zig").ConstMap;
pub const ConstValueMap = @import("core/ir.zig").ConstValueMap;
pub const ConstEvalStateMap = @import("core/ir.zig").ConstEvalStateMap;
pub const functionKey = @import("core/ir.zig").functionKey;
pub const constKey = @import("core/ir.zig").constKey;
