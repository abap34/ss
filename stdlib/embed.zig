pub const core_classes = @embedFile("core/classes.ss");
...
pub const core_transforms = @embedFile("core/transforms.ss");
...
pub const python_keywords = @embedFile("highlighters/python_keywords.py");
