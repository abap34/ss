...
fn/! h2(text_value: String) -> Object
  ...
  txt(content, "Helvetica", 28, 30, c"0,0,0.0353", 42, 96, 96, 700)
  return content
end

fn/! h3(text_value: String) -> Object
  let content = sub_obj(text_value)
  txt(content, "Helvetica", 24, 28, c"0,0,0.0353", 36, 96, 96, 700)
  return content
end
...
fn/! subhead(subtitle_text: String) -> Object
  ...
  txt(subtitle, "Helvetica", 12, 24, c"0,0,0.0353", 34, 96, 96, 700)
  return subtitle
end
...
fn/! cover(title_text: String, subtitle_text: String, author_name: String, date: String = "") -> Object
  ...
  txt(subtitle, "Helvetica", 18, 24, c"0,0,0.0353", 34, 96, 96, 700)
