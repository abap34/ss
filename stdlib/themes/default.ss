...
fn h1(title_text: String) -> Object
  ...
  txt(title, "Helvetica-Bold", "30", "36", "0.07,0.08,0.10", "40", "72", "72")
  return title
end

fn h2(subtitle_text: String) -> Object
  let subtitle = sub_obj(subtitle_text)
  txt(subtitle, "Helvetica-Bold", "20", "26", "0.10,0.11,0.13", "30", "96", "96")
  return subtitle
end
...
fn head(title_text: String) -> Object
  ...
  txt(title, "Helvetica-Bold", "28", "34", "0.07,0.08,0.10", "28", "72", "72")
  rule_l(rule, "0.66,0.70,0.76", "0.9", "")
...
fn subhead(subtitle_text: String) -> Object
  ...
  txt(subtitle, "Helvetica-Bold", "18", "24", "0.10,0.11,0.13", "30", "96", "96")
...
fn text(text_value: String) -> Object
  ...
  md_code(body, "15", "20", "12", "10", "0.97,0.98,0.99", "0.84,0.86,0.90", "0.8", "6")
  return body
end

fn tex(text_value: String, scale: Number = 1) -> Object
  let obj = frame(text_value, "math", "math_tex", "96", "96", 8, 8, "1,1,1", "0.86,0.88,0.92", "0.7", "6")
...
fn code(text_value: String, language_name: String = "python") -> Object
  return code_box(text_value, language_name, "96", "96", 12, 10, "0.97,0.98,0.99", "0.84,0.86,0.90", "0.8", "6")
end
...
fn toc(title_text: String) -> Object
  ...
  box(chrome, "1,1,1", "0.84,0.86,0.90", "0.8", "6")
...
fn cover(title_text: String, subtitle_text: String, author_name: String) -> Object
  ...
  txt(title, "Helvetica-Bold", "48", "56", "0.07,0.08,0.10", "24", "72", "72")
  txt(subtitle, "Helvetica", "22", "30", "0.24,0.27,0.32", "22", "72", "72")
  txt(author, "Helvetica", "18", "24", "0.36,0.40,0.46", "18", "72", "72")
